...
public class SearchResultAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public SearchResultAdapter(List<Medicines> medicines) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            ...
            case TYPE_NO_ITEM:
                View v_no_item = LayoutInflater.from(parent.getContext()).inflate(R.layout.no_search_result, parent, false); //Inflating the layout
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (holder.getItemViewType()){
            case TYPE_DEFAULT:
                ...
                SearchResultAdapter.ViewHolder vhDefault = (SearchResultAdapter.ViewHolder)holder;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            parentLayout.setOnClickListener(SearchResultAdapter.this);
